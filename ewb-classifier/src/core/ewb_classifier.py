...
"""
This module is a wrapper around the clf-inference-intelcomp module (Inference system for hierarchical text classification) to use within the EWB project.
